...
ActiveRecord::Schema[7.0].define(version: 2022_09_01_110303) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "tweet_id"], name: "index_likes_on_account_id_and_tweet_id", unique: true
  ...
  add_foreign_key "followers", "accounts", column: "subscriber_id"
